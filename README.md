...
This repository contains the code for the paper "Evaluating Pre-Training Objectives for TITE" accepted to CLEF 2026.
...
Fine-tuning is done using [Lightning IR](https://webis.de/lightning-ir/index.html). The configuration files for fine-tuning are in the `lightning-ir-configs` directory.
