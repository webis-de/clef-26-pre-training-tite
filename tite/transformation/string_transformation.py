...
class SentenceTransformation(StringTransformation):
    ...
    def split(self, text: str) -> list[str]:
        sb = SentenceBlock()
        return sb._merge_short_sentences(self.tokenizer.tokenize(text))
...
class SentenceShuffle(SentenceTransformation):

    def __init__(self, seed: int | None = None, transformation_prob: float = 1.0) -> None:
        super().__init__(transformation_prob)
        self.seed = seed
