...
class EnhancedLMHead(PreTrainingHead):
    ...
    def __init__(
        ...
        if config.norm_location == "pre":
            ...
            self.norm = torch.nn.Identity()
        self.enhanced_attention = EnhancedMaskedAttention(config, mask_strategy=mask_strategy, mask_prob=mask_prob, mask_window_size=mask_window_size)
...
class ContrastiveLMHead(PreTrainingHead):
    ...
    def forward(
        ...
        **kwargs,
        ...
        original_output = F.normalize(original_output.squeeze(1))
        transformed_output = F.normalize(transformed_output.squeeze(1))
...
class TiteForPreTraining(TitePreTrainedModel):
    ...
    _tied_weights_keys = [
        ...
        "heads.enhanced_masked_auto_encoding.position_embeddings.weight",
        "heads.enhanced_masked_auto_encoding.position_embeddings.bias",
        ...
        "heads.enhanced_windowed_auto_encoding.lm_head.decoder.weight",
        "heads.enhanced_windowed_auto_encoding.lm_head.decoder.bias",
        "heads.enhanced_windowed_auto_encoding.embeddings.word_embeddings.weight",
        "heads.enhanced_windowed_auto_encoding.embeddings.downscale.weight",
        "heads.enhanced_windowed_auto_encoding.embeddings.position_embeddings.weight",
        "heads.enhanced_windowed_auto_encoding.embeddings.norm.weight",
        "heads.enhanced_windowed_auto_encoding.embeddings.norm.bias",
        "heads.enhanced_windowed_auto_encoding.embedding_norm.weight",
        "heads.enhanced_windowed_auto_encoding.embedding_norm.bias",
        "heads.enhanced_windowed_auto_encoding.position_embeddings.weight",
        "heads.enhanced_windowed_auto_encoding.position_embeddings.bias",
    ]
